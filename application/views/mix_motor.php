...
<section id="page-wrapper" style="min-height: 750px;">
    <section id="content-wrapper">
        ...
        <div class="row">
            <div class="col-6">
                <img style="position: absolute;z-index: 11; left: 20%; top: 5vh;" src="<?php echo base_url("public/img/motor.png") ?>">
            </div>
            <div class="col-6">
        ...
        <div class="row">
            ...
            <div class="col-10" style="background-color: lightgray;border-radius: 30px;">
                ...
                <select class="form-control" id="select_merek"  data-size="5">
                  <option value="" >-- Pilih Merek --</option>

                    <?php
                    foreach($mtr as $R) {
                        ?>
                        <option value="<?php  echo $R->IdBrand;  ?>" data-tokens='honda'><?php echo $R->NamaBrand ?></option>
                    <?php } ?>
                </select>
   ...
   <div class="row">
    ...
    <div class="col-4">
       <center>
        ...
        <!-- <input class="form-control" style="background-color: #d2a300; float: left;" type="submit" value="Mix n Match!" name=""> -->
    </center>
</div>
<div class="col-4"></div>
</div>
  ...
  var idType = 0
    ...
    $(document).ready(function(){
      ...
      $('#select_merek').change(function(){
        ...
        $.get(url+'Mix/api_varian_merek_motor/'+id_select_brand, function(data, status){
          var data = JSON.parse(data)
          html += '<option value="">-- Pilih Varian --</option>'
